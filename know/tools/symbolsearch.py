...
class SearchSymbolsTool(BaseTool):
    ...
    def get_openai_schema(self) -> dict:
        ...
        return {
            ...
            "solve users request. All paramers use AND logical condition. To do symbol discovery "
            "run this tool with different combinations of parameters instead of populating all "
            "parameters at once. Prefer semantic search over documentation search.",
            "parameters": {
                "type": "object",
                "properties": {

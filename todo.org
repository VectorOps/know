#+title: Todo
* [ ] No packages should be created for text/rest files
* [ ] Embedding priority mode does not run them first
* [ ] Optimize chunker to tokenize and then de-tokenize to generate result?
* [ ] Move data helpers out of data.py

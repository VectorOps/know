...
* [ ] Search tool
** [ ] Lower weight of literal symbols?
...
*** [ ] Add support for for_statement, raise_statement, with_statement
** [X] Golang
...
*** [ ] Add support for statement_block, string, ternary_expression
*** [ ] Do not warn on empty_statement
*** [ ] Parser handled node but produced no symbols line=84 node_type=expression_statement path=django/contrib/admin/options.py raw='HORIZONTAL, VERTICAL = 1, 2'
*** [ ] JS parser: unhandled export statement line=21 path=tests/staticfiles_tests/project/documents/cached/module.js raw='export * from "./module_test.js";'
** [ ] C
** [ ] C#
** [ ] Java
** [ ] PHP

...
* [ ] Auto-refresh
** [ ] Auto-refresh on every tool call
** [ ] Auto-refresh on tool call, but not more often than every X minutes
** [ ] Auto-refresh associated repos or primary repo
...
** [ ] Boost final score of functions/methods/symbol definitions
- Store boost coefficient in the symbol itself when calculating
** [ ] Figure out field awareness and ranking

...
* [ ] Figure out a way to call functions for language parsers after finishing parsing files
* [ ] Language support
** [ ] Golang
*** [ ] When parsing golang methods, link these symbols back to structure that should be defined in the same package.
** [ ] JavaScript
** [ ] TypeScript
* [ ] Add git support
